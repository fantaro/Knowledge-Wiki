...
```shell
sudo pacman -Syu && sudo pacman -Sc --noconfirm && paru -Syu && paru -Sc --noconfirm && sudo flatpak update && ya pkg upgrade && zplugin-update
```
